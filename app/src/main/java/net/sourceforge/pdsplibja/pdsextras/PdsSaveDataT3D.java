...
public class PdsSaveDataT3D {
	 ...
	 **/
	public PdsSaveDataT3D(Context context, String filename) {
	 ...
	 **/
	public void Printf(double T,double X,double Y,double Z) {
		String cadena1;
	...
	/**
	 * Este método provoca que se usamos uma instancia de PdsSaveDataT3D
